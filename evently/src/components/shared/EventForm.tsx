      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
          <div className="flex flex-col md:flex-row gap-5">
            <div className="w-full" data-aos="fade-up-right" data-aos-duration="1000" data-aos-once="true">
              <FormField
            ...
            <div className="w-full" data-aos="fade-up-left" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true">
              <FormField
                control={form.control}
                name="categoryId"
                render={({ field }) => (
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <div className="w-full" data-aos="fade-up-right" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
              <FormField
                control={form.control}
                name="description"
                render={({ field }) => (
            ...
            <div className="w-full" data-aos="fade-up-left" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
              <FormField
                control={form.control}
                name="imageUrl"
                render={({ field }) => (
          ...
          <div className="flex flex-col md:flex-row gap-5" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <FormField
              control={form.control}
              name="location"
              render={({ field }) => (
          ...
          <div className="w-full" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="700" data-aos-once="true">
