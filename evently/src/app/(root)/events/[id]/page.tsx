  ...
  return (
    <>
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-center bg-contain py-5 md:py-10">
        <div className="bg-rose-600 grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          <Image src={event.imageUrl} alt="event" width={1000} height={1000} className="h-full min-h[300px] object-cover object-center" />
        </div>
        <div className="flex flex-col w-full gap-8 p-5 md:p-10">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col md:flex-row gap-2 md:gap-3">
              ...
              <div className="flex flex-wrap items-center gap-x-1 p-medium-16 lg:p-regular-20">
                <p>
